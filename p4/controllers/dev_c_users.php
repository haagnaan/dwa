...
-------------------------------------------------------------------------------------------------*/
		...
		# Email the new user
			...
			$subject = "Welcome to iamkoba";	
			$body = "Hi ".$_POST['first_name'].", welcome to the koba site for alums";
			$email = Email::send($to, $from, $subject, $body, true, $cc, $bcc);

		echo "You're registered! Check your email for confirmation and go to<a href='/users/login'>here</a> and login";
